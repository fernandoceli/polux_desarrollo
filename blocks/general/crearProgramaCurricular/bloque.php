...
namespace general\crearProgramaCurricular;
...
use general\crearProgramaCurricular\funcion\redireccion;

// Esta clase actua como control del bloque en un patron FCE
if (! class_exists ( '\\general\\crearProgramaCurricular\\Bloque' )) {
