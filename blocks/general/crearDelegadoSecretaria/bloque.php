...
namespace general\crearDelegadoSecretaria;
...
use general\crearDelegadoSecretaria\funcion\redireccion;

// Esta clase actua como control del bloque en un patron FCE

if (! class_exists ( '\\general\\crearDelegadoSecretaria\\Bloque' )) {
