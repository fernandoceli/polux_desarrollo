...
namespace proyecto\iniciarProyecto\formulario;
	...
	<div class="area-msg">
		...
		<table id="tInfo">
			<tr>
				...
				<td>Anteproyecto No. <?php echo $matrizAnteproyecto[0]['antp_antp'];?></td>
			</tr>
			<tr>
				<td><b>Titulo:</b></td>
				<td><?php echo $matrizAnteproyecto[0]['antp_titu'];?></td>
			</tr>
			<tr>
