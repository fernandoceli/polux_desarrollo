<div class="modal fade popup" id="myModal" role="dialog">
    <div class="modal-dialog popup_margin margen-interna corner">
      ...
      <div class="modal-content ">
        ...
        // buscar revisiones
        $atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarRevisionesPrueba", $_REQUEST['proyecto'] );
		...
		<table class="table">
			<tr>
				...
				No. <?php echo $revisiones[$i]['dproy_vers']?></td>
			</tr>
			...
			<tr>
				...
				<td class="estilo_tr" style="padding: 4px;">
					<?php echo $revisiones[$i]['srdp_fcrea'];?>
				</td>
				<td class="estilo_tr" style="padding: 4px;">
					<?php 
