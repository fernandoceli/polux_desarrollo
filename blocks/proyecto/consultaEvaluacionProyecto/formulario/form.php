...
namespace proyecto\consultaEvaluacionProyecto\formulario;
...
<div class="canvas-contenido">
	...
	<table id="documento" class="table">
		<tr>
			<td id="col" rowspan="7">
				<div class="corner bg-imagen-documento">
					...
					<div class="codigo-documento">Versión No. <?php echo $matrizRevision[0][4]?></div>
				</div>
			</td>
		...
		<tr>
			...
			<td class="estilo_tr"><?php echo $matrizRevision[0][4]?></td>
		</tr>
