...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['mensaje'] = 'Nueva versión de documento de anteproyecto';
		$atributos ['tamanno'] = 'Enorme';
		$atributos ['linea'] = 'true';
		echo $this->miFormulario->campoMensaje ( $atributos );
		unset ( $atributos );
		
		?><h3>Información General</h3><?php
		...
		$val='';
		for($i = 0; $i < count($matrizItems2)-1; $i++){
			$val= $val. $matrizItems2[$i]['estudiante'].'-'.$matrizItems2[$i]['nombre'].', ';
		}
		$val=$val. $matrizItems2[count($matrizItems2)-1]['estudiante'].'-'.$matrizItems2[count($matrizItems2)-1]['nombre'];
		...
		$versionDoc=$documentoAnteproyecto[0]['dantp_vers']+1;
		$atributos ['valor'] = 'Versión No. '.$versionDoc;
		...
		$version=$documentoAnteproyecto[0]['dantp_vers']+1;
		...
		$valorCodificado .= "&version=" . $version;
