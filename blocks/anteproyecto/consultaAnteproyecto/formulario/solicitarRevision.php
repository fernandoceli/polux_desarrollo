	...
	function formulario() {
		...
		<div class="bg-seccion corner ">
			...
			<div class="seccion corner margen-interna ">
				...
				<?php
				$atributos ['mensaje'] = 'Solicitud de Evaluación de anteproyecto';
				...
				<br>
					...
					<table id="tInfo">
						...
						<tr>
							<td><b>Titulo:</b></td>
							<td><?php echo $matrizAnteproyecto[0][3];?></td>
						</tr>
						<tr>
							<td><b>Descripcion:</b></td>
							<td><?php echo $matrizAnteproyecto[0][5];?></td>
						</tr>
						<tr>
				...
				for($i = 0; $i < count ( $matrizAutores ); $i ++) {
					echo $matrizAutores  [$i][0] . " - " . $matrizAutores  [$i][1];
					?><br><?php 
				}
				?>
						</td>
						...
						<tr>
							<td><b>Versión del documento a evaluar:</b></td>
							<td><FONT COLOR="#C00">Versión No. <?php echo $documentoAnteproyecto[0][1];?></FONT></td>
						</tr>
					</table>
				</div>
								...
								<tr>
									...
									<td>
										<div class="mensaje-ayuda">
											...
											IMPORTANTE: La versión del documento que se envia es la última subida al sistema. 
											Por favor verifique si el número de la versión corresponde a la versión que realmente 
											desea que sea evaluada.
										</div>
									</td>
		...
		$atributos ['mensaje'] = 'Esta seguro que desea solicitar revision del proyecto?
					Recuerda que la version que se radicara, sera la Version No. ' . $versionDoc[0][0];
		$atributos ['tipo'] = '';
		$atributos ['estilo'] = '';
		...
		*/
		...
		$valorCodificado .= "&version=".$documentoAnteproyecto[0][1];
		// var_dump($_REQUEST);
		/**
