...
//---------------Inicio Formulario (<form>)--------------------------------
    ...
    else if ($_REQUEST['mensaje'] == 'confirmaVersion') {
    	$tipo = 'success';
    	$mensaje = $this->lenguaje->getCadena ( 'mensajeRegistroVersion' );
    	$boton = "continuar";
    ...
    else if ($_REQUEST['mensaje'] == 'confirmaSolicitud') {
    	$tipo = 'success';
    	$mensaje = $this->lenguaje->getCadena ( 'mensajeRegistroSolicitud' );
    	$boton = "continuar";
    ...
    else if($_REQUEST['mensaje'] == 'errorVersion') {
    	$tipo = 'error';
    	$mensaje =  $this->lenguaje->getCadena('mensajeErrorVersion');
    	$boton = "regresar";
    	$valorCodificado = "pagina=".$esteBloque['nombre'];
    	$valorCodificado.="&opcion=nuevo";
    	$valorCodificado.="&bloque=" . $esteBloque["id_bloque"];
    ...
    else if($_REQUEST['mensaje'] == 'errorSolicitud') {
    	$tipo = 'error';
    	$mensaje =  $this->lenguaje->getCadena('mensajeErrorSolicitud');
    	$boton = "regresar";
    	$valorCodificado = "pagina=".$esteBloque['nombre'];
    	$valorCodificado.="&opcion=nuevo";
    	$valorCodificado.="&bloque=" . $esteBloque["id_bloque"];
