...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['estilo'] = 'jqueryui ancho';
		...
		<div class="campoBoton" style="padding-left: 0px;">
			<button type="button" id="btn1" class="ui-button ui-state-default ui-corner-all 
			ui-button-text-only" style="width:120px; height:35px;">Agregar</button>
		</div>
