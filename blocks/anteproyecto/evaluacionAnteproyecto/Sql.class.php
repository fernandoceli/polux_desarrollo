...
namespace anteproyecto\evaluacionAnteproyecto;
...
class Sql extends \Sql {
	...
	function getCadenaSql($tipo, $variable = '') {
		...
		switch ($tipo) {
			...
			case 'buscarCod' :
				$cadenaSql = "SELECT identificacion ";
				$cadenaSql .= "FROM ";
				$cadenaSql .= "polux_usuario ";
				$cadenaSql .= "WHERE ";
			...
			case "actualizarEstadoSolicitud" :
				...
				$cadenaSql .= " and slrev_prof_asignado='" . $variable . "' ";
			...
			case "actualizarEstadoAntp" :
				$cadenaSql = " UPDATE trabajosdegrado.ant_tantp ";
				$cadenaSql .= " SET antp_eantp = 'NO APROBADO'";
				$cadenaSql .= " WHERE antp_antp=" . $_REQUEST ['ante'] . " ";
				// echo $cadenaSql;
				break;
			
			case 'buscarUltimoDocumento' :
			...
			case 'ultimaIteracion' :
				...
				$cadenaSql .= "WHERE ";
				$cadenaSql .= "slrev_antp=" . $_REQUEST ['ante'] . " ";
