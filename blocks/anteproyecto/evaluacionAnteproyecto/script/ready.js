...
$('#btn3').on('click', function() {
	...
	var pregunta3 = {id:3, respuesta:$('#<?php echo $this->campoSeguro('pregunta33')?>').val(), justificacion:$('#<?php echo $this->campoSeguro('justificacion33')?>').val()};
	...
	var arreglo3 = [pregunta1, pregunta2, pregunta3, pregunta4];
