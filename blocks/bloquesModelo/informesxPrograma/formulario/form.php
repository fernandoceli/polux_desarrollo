...
namespace bloquesModelo\informesxPrograma\formulario;
...
class Formulario {
	...
	function formulario() {
		...
		if ($rol == "Coordinador") {
			...
			$_REQUEST ["variable"] = $matrizInformes [0] [0];
		}
		...
		if (isset ( $_REQUEST ['variable'] )) {
			...
			$mensaje = 'Informes finales por programa curricular - ' . $matrizNombre [0] [0] . " - ";
		} else {
			$mensaje = 'Informes finales por programa curricular ';
		}
...
<div class="ui-widget">
	<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
		<p>
			...
			No existen informes finales pertenecientes al programa curricular.
		</p>
	</div>
</div>
<?php
