...
<!-- 		<button type="button" id="btn3">Iniciar proyecto</button> -->
	...
	<div id="der">
		...
		<?php
			...
			<div class="plugin">
				<div>
					<span class="titulo-tablero-revision">Solicitudes de AsignaciÛn de
						Revisor</span>
				</div>
				<div>
							...
							<tr>
								...
								<td>
									<div class="mensaje-ayuda">
										<div>
											Aun no existen solicitudes de asignaciÛn revisor iniciadas
											por el programa curricular. <br> <br> <b>NOTA:</b> Una vez el
											programa curricular inicie las solicitudes, los revisores
											tendr·n un plazo m·ximo de <span class="resaltado">10 dÌas
