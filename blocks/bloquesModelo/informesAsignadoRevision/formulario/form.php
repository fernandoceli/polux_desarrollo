...
namespace bloquesModelo\informesAsignadoRevision\formulario;
...
// 		var_dump ( $matrizInformes );
		...
		if (isset ( $_REQUEST ['variable'] )) {
			...
			$atributos ['mensaje'] = 'Informes Finales Asignados Para Revisi&oacute;n - ' . $matrizNombre [0] [0] . " - " . $_REQUEST ["variable"];
		} else {
			$atributos ['mensaje'] = 'Informes Finales Asignados Para Revisi&oacute;n ';
		}
						...
						<div class="area-msg corner margen-interna ">
							...
							<div class="content-msg info corner">
								...
								<div style="padding: 5px 0px;">
									<div>
										<contenido> No existen informes finales actualmente asignados
										para revisi&oacute;n.
