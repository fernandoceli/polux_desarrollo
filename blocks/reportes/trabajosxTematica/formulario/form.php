<?php 
namespace reportes\trabajosxTematica\formulario;
...
class Formulario {
    ...
    function formulario() {
        ...
        */
        ...
        require_once ('/../reporteador/reportico.php');
        $q = new reportico();
        $q->initial_project_password = "admin123"; // If required
        if (isset($_REQUEST['variable'])) {
        	$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarTrabajos", $_REQUEST['variable'] );
        } else {
        	$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarTrabajos", '0' );
        }
        $q->initial_sql = $atributos ['cadena_sql'];
