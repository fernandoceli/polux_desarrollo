...
namespace informeFinal\informesAsignadoRevision\formulario;
	...
	function formulario() {
		...
		if (in_array ( "Coordinador", $rol )) {
			...
			if (! isset ( $_REQUEST ['variable'] )) {
				$_REQUEST ["variable"] = substr($roles [0] [0], 2, strlen($roles [0] [0]));
			}
...
// 		var_dump ( $matrizInformes );
		...
		if (isset ( $_REQUEST ['variable'] )) {
			...
			$mensaje = 'Informes Finales Asignados Para Revisi&oacute;n - ' . $matrizNombre [0] [0] . " - " . $_REQUEST ["variable"];
		} else {
			$mensaje = 'Informes Finales Asignados Para Revisi&oacute;n ';
		}
...
<div class="ui-widget">
	<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
		<p>
			...
			No existen informes finales actualmente asignados para revisi&oacute;n.
		</p>
	</div>
</div>
<?php
