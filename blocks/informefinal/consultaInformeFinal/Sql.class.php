	...
	function getCadenaSql($tipo, $variable = '') {
		...
		switch ($tipo) {
			...
			case "registrarSustentacion" :
				...
				$cadenaSql .= "'" . $_REQUEST ['observacionesS'] . "', ";
			...
			case 'registrar' :
				...
				$cadenaSql = "INSERT INTO trabajosdegrado.inf_tjur";
				$cadenaSql .= "(";
				$cadenaSql .= "jur_info, ";
				$cadenaSql .= "jur_prof, ";
				$cadenaSql .= "jur_fasig, ";
			...
			case "registrarFinalizacion" :
				$fecha = date ( 'Y-m-d' );
				$cadenaSql = "UPDATE ";
				$cadenaSql .= "trabajosdegrado.inf_tsust ";
				$cadenaSql .= " SET ";
				$cadenaSql .= "sust_nota= " . $_REQUEST ['calificacionFinal'] . ", ";
				$cadenaSql .= "sust_caracter= '" . $_REQUEST ['seleccionarConceptoSustentacion'] . "', ";
				$cadenaSql .= "sust_usua_fin= '" . $_REQUEST ['usuario'] . "', ";
				$cadenaSql .= "sust_observ_fin= '" . $_REQUEST ['observacionesFinalizacion'] . "', ";
				$cadenaSql .= "sust_ffin= '" . $fecha . "' ";
				$cadenaSql .= " WHERE sust_info='" . $_REQUEST ['informe'] . "' ";
				echo ($cadenaSql);
				break;
			...
			case "actualizarEstado" :
				...
				$cadenaSql .= " SET info_einfo= 'ASIGNANDO JURADOS'";
			...
			case "actualizarFinalizacion" :
				$cadenaSql = " UPDATE trabajosdegrado.inf_tinfo ";
				$cadenaSql .= " SET info_einfo= 'FINALIZADO'";
				$cadenaSql .= " WHERE info_info='" . $_REQUEST ['informe'] . "' ";
				echo $cadenaSql;
				break;
			...
			case 'buscarConceptosSustentacion' :
				
				$cadenaSql = 'SELECT ';
				$cadenaSql .= "crmd_caracter, ";
				$cadenaSql .= "crmd_caracter ";
				$cadenaSql .= 'FROM ';
				$cadenaSql .= 'trabajosdegrado.inf_tcrmd ';
				$cadenaSql .= "WHERE ";
				$cadenaSql .= "crmd_moda=1";
				// echo $cadenaSql;
				break;
			...
			case 'buscarHistorial' :
				...
				$cadenaSql = 'SELECT ';
				$cadenaSql .= 'hinfo_fasig as FECHA,';
				$cadenaSql .= 'hinfo_einfo as ESTADO, ';
				$cadenaSql .= "(u.nombre || ' ' ||u.apellido) AS  USUARIO, ";
				$cadenaSql .= 'hinfo_obser as OBSERVACIONES ';
				$cadenaSql .= 'FROM ';
				$cadenaSql .= 'trabajosdegrado.inf_thinfo, ';
				$cadenaSql .= "public.polux_usuario u ";
				$cadenaSql .= 'WHERE ';
				$cadenaSql .= 'hinfo_info =' . $variable;
				$cadenaSql .= " and (hinfo_usua=u.id_usuario)";
				// echo $cadenaSql;
				break;
			...
			case 'buscarDocumento3' :
				...
				$cadenaSql .= "FROM ";
				$cadenaSql .= "trabajosdegrado.inf_tdinfo ";
				$cadenaSql .= "WHERE dinfo_info='" . $_REQUEST ['informe'] . "' ";
			...
			case 'buscarAutores2' :
				...
				$cadenaSql .= 'trabajosdegrado.ge_testd e ';
				$cadenaSql .= 'WHERE ';
				$cadenaSql .= 'estantp_antp =' . $_REQUEST ['informe'];
				$cadenaSql .= ' and e.estd_us =u.id_usuario';
