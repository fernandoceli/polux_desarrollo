...
$('#<?php echo $this->campoSeguro('observaciones')?>').width(410);
...
$('#<?php echo $this->campoSeguro('seleccionarConceptoSustentacion')?>').width(280);
$('#<?php echo $this->campoSeguro('seleccionarConceptoSustentacion')?>').select2();
