...
if (! isset ( $GLOBALS ["autorizado"] )) {
	...
	else if ($_REQUEST ['mensaje'] == 'confirma4') {
		$tipo = 'success';
		$mensaje = $this->lenguaje->getCadena ( 'mensajeRegistro4' );
		$boton = "continuar";
	...
	else if ($_REQUEST ['mensaje'] == 'error4') {
		$tipo = 'error';
		$mensaje = $this->lenguaje->getCadena ( 'mensajeError4' );
		$boton = "regresar";
		$valorCodificado = "pagina=" . $esteBloque ['nombre'];
		$valorCodificado .= "&opcion=nuevo";
		$valorCodificado .= "&bloque=" . $esteBloque ["id_bloque"];
