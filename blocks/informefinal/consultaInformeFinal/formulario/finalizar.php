...
class Formulario {
	...
	function formulario() {
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarAutores2", $_REQUEST ['informe'] );
		...
		$atributos ['mensaje'] = 'Finalizar Información de Sustentación de Informe Final';
		...
		<table id="documento" class="table">
			<tr>
				...
				<td class="estilo_tr"><?php echo "Informe Final No. " .$matrizItems [0][0] ;?></td>
			</tr>
			<tr>
				<td class="table-tittle estilo_tr">Titulo del informe final</td>
				<td class="estilo_tr"><?php echo $matrizItems [0][4] ;?></td>
			</tr>
			<tr>
				<td class="table-tittle estilo_tr">Descripción</td>
				<td class="estilo_tr"><?php echo $matrizItems [0] [6] ;?></td>
			</tr>
		...
		for($i = 0; $i < count ( $matrizAutores ); $i ++) {
			echo $matrizAutores [$i] ['estudiante'] . " - " . $matrizAutores [$i] ['nombre']."<br>";
		}
		?>
				</td>
			</tr>
			...
			<tr>
				<td class="table-tittle estilo_tr">Temáticas</td>
		...
		<br>
			<h3>Información requerida para finalización de la sustentación</h3>
			<br>
		<?php
		
		// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
		$esteCampo = 'calificacionFinal';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		...
		$esteCampo = 'seleccionarConceptoSustentacion';
		$atributos ['nombre'] = $esteCampo;
		$atributos ['id'] = $esteCampo;
		...
		$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarConceptosSustentacion" );
		$matrizItems = $esteRecurso->ejecutarAcceso ( $atributos ['cadena_sql'], "busqueda" );
		...
		// ---------------- CONTROL: Cuadro de Texto --------------------------------------------------------
		$esteCampo = 'observacionesFinalizacion';
		$atributos ['id'] = $esteCampo;
		$atributos ['nombre'] = $esteCampo;
		$atributos ['tipo'] = 'text';
		$atributos ['estilo'] = 'jqueryui';
		...
		$valorCodificado .= "&opcion=finalizar";
		/**
