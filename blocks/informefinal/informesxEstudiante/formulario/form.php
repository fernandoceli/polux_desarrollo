...
namespace informeFinal\informesxEstudiante\formulario;
...
class Formulario {
	...
	function formulario() {
		...
		if (in_array("Estudiante", $rol)) {
			$acceso = true;
			$atributos ['cadena_sql'] = $this->miSql->getCadenaSql ( "buscarCodigo", $usuario );
						...
						<div class="ui-state-error ui-corner-all" style="padding: 0 .7em;">
							<p>
								<span class="ui-icon ui-icon-alert"
									style="float: left; margin-right: .3em;"></span> <strong>Informaci&oacute;n!</strong>
								No hay informes finales registrados para el estudiante.
							</p>
						</div>
					</div>
<?php
