...
namespace informeFinal\iniciarInformeFinal\formulario;
...
<div id="contenido">
	...
	<br>
		<?php
		$atributos ['mensaje'] = ' Radicación del informe final';
		$atributos ['tamanno'] = 'Enorme';
		$atributos ['estiloEnLinea'] = "margin-left: 1%";
		...
		for($i = 0; $i < count ( $matrizAutores ); $i ++) {
			echo $matrizAutores [$i] [0] . " - " . $matrizAutores [$i] [1].'<br>';
		}
		?>
		</td>
			</tr>
			<tr>
				<td><b>Versión del documento a radicar:</b></td>
				<td>Versión No. <?php echo $matrizProyecto[0]['dproy_vers'];?></td>
			</tr>
		</table>
		...
		<table class="table3">
			...
			Informe Final es la última subida al sistema. Por favor verifique si el
			número corresponde a la versión que realmente desea que sea evaluada.
